...
use super::{
    create_config_text_id_factory, AnySendSync, Config, ConfigIndexerMap, ConfigLabel,
    ConfigsLoadingContext, Prepare,
};
...
pub struct ConfigTypeRegistry {
    pub(super) type_map: HashMap<TypeId, (CreateAnyBox, LabelMapToIdMap)>,
